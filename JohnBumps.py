...
async def show_category_products(message, category, user_id, selected_city):
    ...
    if category == "designer":
        keyboard = [
            [InlineKeyboardButton("💊 Мефедрон (порошок)", callback_data="product_mefedron_poroh")],
            [InlineKeyboardButton("💎 Мефедрон кристалл", callback_data="product_mefedron_crystal")],
            ...
            [InlineKeyboardButton("🔥 AMFETAMINE PINK AMG OMG! (1г)", callback_data="product_amphetamine_pink")],
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ========== ТОВАРЫ С ФОТО ==========
    product_info = {
        # Дизайнерские (2 фото: alpha.jpg + alpha1.jpg)
        "product_alpha_pvp_01": {"name": "Альфа-ПвП (0.1г)", "price": "990₽/0.1гр.", "file": "alpha.jpg", "photo2": "alpha1.jpg", "unit": "гр", "min_order": 0.1},
        "product_alpha_pvp_05": {"name": "Альфа-ПвП (0.5г)", "price": "1500₽/0.5гр.", "file": "alpha.jpg", "photo2": "alpha1.jpg", "unit": "гр", "min_order": 0.5},
        "product_alpha_pvp_10": {"name": "Альфа-ПвП (1.0г)", "price": "2300₽/гр.", "file": "alpha.jpg", "photo2": "alpha1.jpg", "unit": "гр", "min_order": 1},
        # Мефедрон (только общее фото)
        "product_mefedron_poroh": {"name": "Мефедрон (порошок)", "price": "1499₽/гр.", "file": "mefedron_poroh.jpg", "unit": "гр", "min_order": 1},
        "product_mefedron_crystal": {"name": "Мефедрон кристалл", "price": "1789₽/гр.", "file": "mefedron_crystal.jpg", "unit": "гр", "min_order": 1},
        # Амфетамин (только общее фото)
        "product_amphetamine_pink": {"name": "AMFETAMINE PINK AMG OMG! (1г)", "price": "2300₽/гр.", "file": "amphetamine_pink.jpg", "unit": "гр", "min_order": 1},
        # Эйфоретики (только общее фото)
        "product_mdma_05": {"name": "MDMA (0.5г)", "price": "2700₽/0.5гр.", "file": "mdma.jpg", "unit": "гр", "min_order": 0.5},
        "product_mdma_10": {"name": "MDMA (1.0г)", "price": "5478₽/гр.", "file": "mdma.jpg", "unit": "гр", "min_order": 1},
        # ЭКСТАЗИ (2 фото: ecstasy.jpg + ecstasy1.jpg)
        "product_ecstasy": {"name": "ЭКСТАЗИ (2.0г)", "price": "2976₽/2гр.", "file": "ecstasy.jpg", "photo2": "ecstasy1.jpg", "unit": "гр", "min_order": 2},
        # Каннабис
        "product_gorilla_glue_05": {"name": "Gorilla Glue (0.5г)", "price": "1649₽/0.5гр.", "file": "gorilla.jpg", "unit": "гр", "min_order": 0.5},
        "product_gorilla_glue_10": {"name": "Gorilla Glue (1.0г)", "price": "3300₽/гр.", "file": "gorilla.jpg", "unit": "гр", "min_order": 1},
        "product_ak47_05": {"name": "AK-47 (0.5г)", "price": "1559₽/0.5гр.", "file": "ak47.jpg", "unit": "гр", "min_order": 0.5},
        "product_ak47_10": {"name": "AK-47 (1.0г)", "price": "3200₽/гр.", "file": "ak47.jpg", "unit": "гр", "min_order": 1},
        "product_high_grade_mix": {"name": "High Grade MIX (1.0г)", "price": "3400₽/гр.", "file": "high.jpg", "unit": "гр", "min_order": 1},
        # Гашиш (2 фото: hashish.jpg + hashish1.jpg)
        "product_hashish_025": {"name": "Гашиш ICE-O-LATOR (0.25г)", "price": "1400₽/0.25гр.", "file": "hashish.jpg", "photo2": "hashish1.jpg", "unit": "гр", "min_order": 0.25},
        "product_hashish_05": {"name": "Гашиш ICE-O-LATOR (0.5г)", "price": "1800₽/0.5гр.", "file": "hashish.jpg", "photo2": "hashish1.jpg", "unit": "гр", "min_order": 0.5},
        "product_hashish_10": {"name": "Гашиш ICE-O-LATOR (1.0г)", "price": "2300₽/гр.", "file": "hashish.jpg", "photo2": "hashish1.jpg", "unit": "гр", "min_order": 1},
        # Аптечные препараты (только одно фото, если есть)
        "product_tramadol": {"name": "Трамадол 50мг", "price": "800₽/шт.", "file": "tramadol.jpg", "unit": "шт", "min_order": 1},
        "product_zolomax": {"name": "Золомакс 100мг", "price": "1200₽/шт.", "file": "zolomax.jpg", "unit": "шт", "min_order": 1},
        "product_pregabalin": {"name": "Прегабалин 300мг", "price": "1100₽/шт.", "file": "pregabalin.jpg", "unit": "шт", "min_order": 1},
        "product_gabapentin": {"name": "Габапентин канон (10шт)", "price": "1100₽/уп.", "file": "gabapentin.jpg", "unit": "уп", "min_order": 1},
        "product_baclofen": {"name": "Баклофен 10мг", "price": "750₽/шт.", "file": "baclofen.jpg", "unit": "шт", "min_order": 1},
        "product_tropicamide": {"name": "Тропикамид 1%", "price": "600₽/шт.", "file": "tropicamide.jpg", "unit": "шт", "min_order": 1},
        "product_phenazepam": {"name": "Феназепам 1мг", "price": "900₽/шт.", "file": "phenazepam.jpg", "unit": "шт", "min_order": 1},
        "product_codeine_syrup": {"name": "Кодеиновый сироп TOSIENA", "price": "5490₽/50мл.", "file": "toseina.jpg", "unit": "мл", "min_order": 1},
        "product_atarax_5": {"name": "Атаракс (5 таб)", "price": "600₽/уп.", "file": "atarax.jpg", "unit": "уп", "min_order": 1},
        "product_atarax_25": {"name": "Атаракс (25 таб)", "price": "1099₽/уп.", "file": "atarax.jpg", "unit": "уп", "min_order": 1},
        "product_quetiapine": {"name": "Кветиапин (10 таб)", "price": "990₽/уп.", "file": "quetiapine.jpg", "unit": "уп", "min_order": 1},
        "product_phenibut": {"name": "Фенибут 250мг (10 таб)", "price": "990₽/уп.", "file": "phenibut.jpg", "unit": "уп", "min_order": 1},
        "product_pregabalin_lyrica": {"name": "Лирика 400мг (5 шт)", "price": "1400₽/уп.", "file": "lyrica.jpg", "unit": "уп", "min_order": 1},
    }
    ...
    if query.data in product_info:
        ...
        try:
            ...
            print(f"⚠️ Файл не найден: {product['file']}")

        # Отправляем ВТОРОЕ фото, если есть
        if "photo2" in product:
            try:
                with open(product["photo2"], 'rb') as photo:
                    await query.message.reply_photo(photo=InputFile(photo))
            except FileNotFoundError:
                print(f"⚠️ Файл не найден: {product['photo2']}")
...
🎯 Выберите адрес для покупки:""",
        ...
        example_addresses = generate_addresses(selected_city, "product_mefedron_poroh")
...
async def handle_quantity_input(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        product = {
            ...
            "product_mefedron_poroh": {"name": "Мефедрон (порошок)", "price": 1499},
            "product_mefedron_crystal": {"name": "Мефедрон кристалл", "price": 1789},
            "product_amphetamine_pink": {"name": "AMFETAMINE PINK AMG OMG! (1г)", "price": 2300},
            # Эйфоретики
