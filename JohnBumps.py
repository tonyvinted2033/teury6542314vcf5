...
# Базы адресов для генерации (без изменений)
streets = {
...
📦 Доступные категории:
• 💊 Дизайнерские - Мефедрон, Альфа-ПвП, Амфетамин
• 🌈 Эйфоретики - MDMA, ЭКСТАЗИ
• 🌿 Каннабис - Gorilla Glue, AK-47, High Grade MIX, Гашиш ICE-O-LATOR
• 💊 Аптечные препараты - Трамадол, Золомакс, Прегабалин, Габапентин, Баклофен, Тропикамид, Феназепам, Кодеиновый сироп, Атаракс, Кветиапин, Фенибут, Лирика
...
async def show_category_products(message, category, user_id, selected_city):
    ...
    if category == "designer":
        keyboard = [
            [InlineKeyboardButton("💊 АМФЕТАМИН VHQ-2289 (1г)", callback_data="product_amphetamine_vhq")],
            [InlineKeyboardButton("💊 AMFETAMINE PINK (1г)", callback_data="product_amphetamine_pink")],
            [InlineKeyboardButton("⚡ Альфа-ПвП (0.1г)", callback_data="product_alpha_pvp_01")],
            [InlineKeyboardButton("⚡ Альфа-ПвП (0.5г)", callback_data="product_alpha_pvp_05")],
            [InlineKeyboardButton("⚡ Альфа-ПвП (1.0г)", callback_data="product_alpha_pvp_10")],
            [InlineKeyboardButton("💊 Мефедрон (1.0г)", callback_data="product_mefedron")],
            [InlineKeyboardButton("💎 Мефедрон кристалл (1.0г)", callback_data="product_mefedron_crystal")],
        ...
        keyboard = [
            [InlineKeyboardButton("💎 MDMA (0.5г)", callback_data="product_mdma_05")],
            [InlineKeyboardButton("💎 MDMA (1.0г)", callback_data="product_mdma_10")],
            [InlineKeyboardButton("💊 ЭКСТАЗИ (2.0г)", callback_data="product_ecstasy")],
            [InlineKeyboardButton("🔙 Назад к категориям", callback_data="back_to_categories")]
        ]
        ...
        keyboard = [
            [InlineKeyboardButton("🧬 Gorilla Glue (0.5г)", callback_data="product_gorilla_glue_05")],
            [InlineKeyboardButton("🧬 Gorilla Glue (1.0г)", callback_data="product_gorilla_glue_10")],
            [InlineKeyboardButton("🔫 AK-47 (0.5г)", callback_data="product_ak47_05")],
            [InlineKeyboardButton("🔫 AK-47 (1.0г)", callback_data="product_ak47_10")],
            [InlineKeyboardButton("⭐ High Grade MIX (1.0г)", callback_data="product_high_grade_mix")],
            [InlineKeyboardButton("🍫 Гашиш ICE-O-LATOR (0.25г)", callback_data="product_hashish_025")],
            [InlineKeyboardButton("🍫 Гашиш ICE-O-LATOR (0.5г)", callback_data="product_hashish_05")],
            [InlineKeyboardButton("🍫 Гашиш ICE-O-LATOR (1.0г)", callback_data="product_hashish_10")],
            [InlineKeyboardButton("🔙 Назад к категориям", callback_data="back_to_categories")]
        ]
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("💊 Габапентин канон (10шт)", callback_data="product_gabapentin")],
            ...
            [InlineKeyboardButton("💊 Атаракс (5 таб)", callback_data="product_atarax_5")],
            [InlineKeyboardButton("💊 Атаракс (25 таб)", callback_data="product_atarax_25")],
            [InlineKeyboardButton("💊 Кветиапин (10 таб)", callback_data="product_quetiapine")],
            [InlineKeyboardButton("💊 Фенибут 250мг (10 таб)", callback_data="product_phenibut")],
            [InlineKeyboardButton("💊 Лирика 400мг (5 шт)", callback_data="product_pregabalin_lyrica")],
            [InlineKeyboardButton("🔙 Назад к категориям", callback_data="back_to_categories")]
        ]
...
async def add_balance(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text(
            f"✅ Баланс пользователя {target_id} увеличен на {amount} ₽. Текущий баланс: {user_balance[target_id]} ₽")
    except Exception as e:
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Обработка товаров с новыми ценами
    product_info = {
        # Дизайнерские
        "product_amphetamine_vhq": {"name": "АМФЕТАМИН VHQ-2289 (1г)", "price": "2289₽/гр.",
                                    "file": "amphetamine_vhq.jpg", "photo2": "amphetamine_vhq1.jpg", "unit": "гр",
                                    "min_order": 1},
        "product_amphetamine_pink": {"name": "AMFETAMINE PINK (1г)", "price": "2300₽/гр.",
                                     "file": "amphetamine_pink.jpg", "photo2": "amphetamine_pink1.jpg", "unit": "гр",
                                     "min_order": 1},
        "product_alpha_pvp_01": {"name": "Альфа-ПвП (0.1г)", "price": "990₽/0.1гр.", "file": "alpha_pvp.jpg",
                                 "photo2": "alpha_pvp1.jpg", "unit": "гр", "min_order": 0.1},
        "product_alpha_pvp_05": {"name": "Альфа-ПвП (0.5г)", "price": "1500₽/0.5гр.", "file": "alpha_pvp.jpg",
                                 "photo2": "alpha_pvp1.jpg", "unit": "гр", "min_order": 0.5},
        "product_alpha_pvp_10": {"name": "Альфа-ПвП (1.0г)", "price": "2300₽/гр.", "file": "alpha_pvp.jpg",
                                 "photo2": "alpha_pvp1.jpg", "unit": "гр", "min_order": 1},
        "product_mefedron": {"name": "Мефедрон (1.0г)", "price": "1499₽/гр.", "file": "mefedron.jpg",
                             "photo2": "mefedron1.jpg", "unit": "гр", "min_order": 1},
        "product_mefedron_crystal": {"name": "Мефедрон кристалл (1.0г)", "price": "1789₽/гр.",
                                     "file": "mefedron_crystal.jpg", "photo2": "mefedron_crystal1.jpg", "unit": "гр",
                                     "min_order": 1},
        # Эйфоретики
        "product_mdma_05": {"name": "MDMA (0.5г)", "price": "2700₽/0.5гр.", "file": "mdma.jpg", "photo2": "mdma1.jpg",
                            "unit": "гр", "min_order": 0.5},
        "product_mdma_10": {"name": "MDMA (1.0г)", "price": "5478₽/гр.", "file": "mdma.jpg", "photo2": "mdma1.jpg",
                            "unit": "гр", "min_order": 1},
        "product_ecstasy": {"name": "ЭКСТАЗИ (2.0г)", "price": "2976₽/2гр.", "file": "ecstasy.jpg",
                            "photo2": "ecstasy1.jpg", "unit": "гр", "min_order": 2},
        # Каннабис
        "product_gorilla_glue_05": {"name": "Gorilla Glue (0.5г)", "price": "1649₽/0.5гр.", "file": "gorilla_glue.jpg",
                                    "photo2": "gorilla_glue1.jpg", "unit": "гр", "min_order": 0.5},
        "product_gorilla_glue_10": {"name": "Gorilla Glue (1.0г)", "price": "3300₽/гр.", "file": "gorilla_glue.jpg",
                                    "photo2": "gorilla_glue1.jpg", "unit": "гр", "min_order": 1},
        "product_ak47_05": {"name": "AK-47 (0.5г)", "price": "1559₽/0.5гр.", "file": "ak47.jpg", "photo2": "ak471.jpg",
                            "unit": "гр", "min_order": 0.5},
        "product_ak47_10": {"name": "AK-47 (1.0г)", "price": "3200₽/гр.", "file": "ak47.jpg", "photo2": "ak471.jpg",
                            "unit": "гр", "min_order": 1},
        "product_high_grade_mix": {"name": "High Grade MIX (1.0г)", "price": "3400₽/гр.", "file": "high_grade_mix.jpg",
                                   "photo2": "high_grade_mix1.jpg", "unit": "гр", "min_order": 1},
        "product_hashish_025": {"name": "Гашиш ICE-O-LATOR (0.25г)", "price": "1400₽/0.25гр.", "file": "hashish.jpg",
                                "photo2": "hashish1.jpg", "unit": "гр", "min_order": 0.25},
        "product_hashish_05": {"name": "Гашиш ICE-O-LATOR (0.5г)", "price": "1800₽/0.5гр.", "file": "hashish.jpg",
                               "photo2": "hashish1.jpg", "unit": "гр", "min_order": 0.5},
        "product_hashish_10": {"name": "Гашиш ICE-O-LATOR (1.0г)", "price": "2300₽/гр.", "file": "hashish.jpg",
                               "photo2": "hashish1.jpg", "unit": "гр", "min_order": 1},
        # Аптечные препараты (новые цены и позиции)
        "product_tramadol": {"name": "Трамадол 50мг", "price": "800₽/шт.", "file": "tramadol.jpg",
                             "photo2": "tramadol1.jpg", "unit": "шт", "min_order": 1},
        "product_zolomax": {"name": "Золомакс 100мг", "price": "1200₽/шт.", "file": "zolomax.jpg",
                            "photo2": "zolomax1.jpg", "unit": "шт", "min_order": 1},
        "product_pregabalin": {"name": "Прегабалин 300мг", "price": "1100₽/шт.", "file": "pregabalin.jpg",
                               "photo2": "pregabalin1.jpg", "unit": "шт", "min_order": 1},
        "product_gabapentin": {"name": "Габапентин канон (10шт)", "price": "1100₽/уп.", "file": "gabapentin.jpg",
                               "photo2": "gabapentin1.jpg", "unit": "уп", "min_order": 1},
        "product_baclofen": {"name": "Баклофен 10мг", "price": "750₽/шт.", "file": "baclofen.jpg",
                             "photo2": "baclofen1.jpg", "unit": "шт", "min_order": 1},
        "product_tropicamide": {"name": "Тропикамид 1%", "price": "600₽/шт.", "file": "tropicamide.jpg",
                                "photo2": "tropicamide1.jpg", "unit": "шт", "min_order": 1},
        "product_phenazepam": {"name": "Феназепам 1мг", "price": "900₽/шт.", "file": "phenazepam.jpg",
                               "photo2": "phenazepam1.jpg", "unit": "шт", "min_order": 1},
        "product_codeine_syrup": {"name": "Кодеиновый сироп TOSIENA", "price": "5490₽/50мл.",
                                  "file": "codeine_syrup.jpg", "photo2": "codeine_syrup1.jpg", "unit": "мл",
                                  "min_order": 1},
        "product_atarax_5": {"name": "Атаракс (5 таб)", "price": "600₽/уп.", "file": "atarax.jpg",
                             "photo2": "atarax1.jpg", "unit": "уп", "min_order": 1},
        "product_atarax_25": {"name": "Атаракс (25 таб)", "price": "1099₽/уп.", "file": "atarax.jpg",
                              "photo2": "atarax1.jpg", "unit": "уп", "min_order": 1},
        "product_quetiapine": {"name": "Кветиапин (10 таб)", "price": "990₽/уп.", "file": "quetiapine.jpg",
                               "photo2": "quetiapine1.jpg", "unit": "уп", "min_order": 1},
        "product_phenibut": {"name": "Фенибут 250мг (10 таб)", "price": "990₽/уп.", "file": "phenibut.jpg",
                             "photo2": "phenibut1.jpg", "unit": "уп", "min_order": 1},
        "product_pregabalin_lyrica": {"name": "Лирика 400мг (5 шт)", "price": "1400₽/уп.", "file": "lyrica.jpg",
                                      "photo2": "lyrica1.jpg", "unit": "уп", "min_order": 1},
    }
...
Цена: {product["price"]}
Минимальный заказ: {product.get('min_order', 1)}{product['unit']}
...
🎯 Выберите адрес для покупки:""",
        ...
        example_addresses = generate_addresses(selected_city, "product_mefedron")
...
async def handle_quantity_input(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        max_limit = 20
        min_order = user_selections[user_id].get("min_order", 1)
        ...
        product = {
            # Дизайнерские
            "product_amphetamine_vhq": {"name": "АМФЕТАМИН VHQ-2289 (1г)", "price": 2289},
            "product_amphetamine_pink": {"name": "AMFETAMINE PINK (1г)", "price": 2300},
            "product_alpha_pvp_01": {"name": "Альфа-ПвП (0.1г)", "price": 990},
            "product_alpha_pvp_05": {"name": "Альфа-ПвП (0.5г)", "price": 1500},
            "product_alpha_pvp_10": {"name": "Альфа-ПвП (1.0г)", "price": 2300},
            "product_mefedron": {"name": "Мефедрон (1.0г)", "price": 1499},
            "product_mefedron_crystal": {"name": "Мефедрон кристалл (1.0г)", "price": 1789},
            # Эйфоретики
            "product_mdma_05": {"name": "MDMA (0.5г)", "price": 2700},
            "product_mdma_10": {"name": "MDMA (1.0г)", "price": 5478},
            "product_ecstasy": {"name": "ЭКСТАЗИ (2.0г)", "price": 2976},
            # Каннабис
            "product_gorilla_glue_05": {"name": "Gorilla Glue (0.5г)", "price": 1649},
            "product_gorilla_glue_10": {"name": "Gorilla Glue (1.0г)", "price": 3300},
            "product_ak47_05": {"name": "AK-47 (0.5г)", "price": 1559},
            "product_ak47_10": {"name": "AK-47 (1.0г)", "price": 3200},
            "product_high_grade_mix": {"name": "High Grade MIX (1.0г)", "price": 3400},
            "product_hashish_025": {"name": "Гашиш ICE-O-LATOR (0.25г)", "price": 1400},
            "product_hashish_05": {"name": "Гашиш ICE-O-LATOR (0.5г)", "price": 1800},
            "product_hashish_10": {"name": "Гашиш ICE-O-LATOR (1.0г)", "price": 2300},
            # Аптека
            ...
            "product_gabapentin": {"name": "Габапентин канон (10шт)", "price": 1100},
            ...
            "product_codeine_syrup": {"name": "Кодеиновый сироп TOSIENA", "price": 5490},
            "product_atarax_5": {"name": "Атаракс (5 таб)", "price": 600},
            "product_atarax_25": {"name": "Атаракс (25 таб)", "price": 1099},
            "product_quetiapine": {"name": "Кветиапин (10 таб)", "price": 990},
            "product_phenibut": {"name": "Фенибут 250мг (10 таб)", "price": 990},
            "product_pregabalin_lyrica": {"name": "Лирика 400мг (5 шт)", "price": 1400},
